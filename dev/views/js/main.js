...
// Got a hint in JSHint that resizePizzas is an unused variable; But it gets called from the pizza.html - so left it as is.
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
	...
	// Switch between pizza sizes - and returning a string containing a percentage value.
	...
	// The newwidth variabel is necessary - because setting width equal to dx in the loop
	// triggers the sizeSwitcher function for every pizza.
	var newwidth = dx;
...
document.addEventListener('DOMContentLoaded', function() {
	...
	for (var i = 0; i < numberPizzas; i++) {
		...
		// Added will-change: left to move the background pizzas to their own layer - instead of transformZ(0) hack.
